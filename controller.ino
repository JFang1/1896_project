...
//
// Description: This file is intended for use with the
//              wearable step tracking device developed
//              as a senior design project during the 
//              Summer 2017 semester at the University
//              of Pittsburgh. It is used to control
//              the Arduino microcontrollers to enable
//              proper calibration of the BNO055 IMU
//              sensors and manage data collection.
//
// Authors:
//    Nathan Anuskiewicz
//    Michael Mortensen
