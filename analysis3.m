...
% %plot original left velocity
% figure(4);
% plot(lAccel(:,4),lV(:,1));
% title('original left velocity')
...
% figure(6);
% plot(lAccel(:,4),lD(:,1));
% title('original left displacement')
...
figure(7);
plot(lAccel(:,4),lD(:,1));
title('smoothed left displacement');
